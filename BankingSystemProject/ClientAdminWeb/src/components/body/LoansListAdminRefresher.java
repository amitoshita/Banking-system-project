...
public class LoansListAdminRefresher extends TimerTask {
    ...
    public LoansListAdminRefresher(BooleanProperty shouldUpdate, Consumer<List<DTOLoan>> loansListConsumer, String url) {
